...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../../backend/app-assets/css/pages/authentication.css">
    <!-- END: Page CSS-->
                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="../../../backend/app-assets/images/pages/login.png" alt="branding logo">
                                </div>
                                        ...
                                        <div class="card-content">
                                            <div class="card-body pt-1">
                                                <form action="{{ url('login')}}" method="POST">
                                                    ...
                                                    <fieldset class="form-label-group position-relative has-icon-left {{ $errors->has('password') ? 'has-error' : ''}}">
