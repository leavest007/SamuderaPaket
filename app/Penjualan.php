...
class Penjualan extends Model
{
    ...
    protected $fillable = ['stt', 'kantor_asal', 'kantor_tujuan', 'pengirim', 'penerima', 'alamat_pengirim', 'alamat_penerima', 'nama_penerus', 'kode_penerus', 'nama_barang', 'payment', 'jumlah_colly', 'packing', 'jenis_harga', 'berat', 'harga_per_kilo', 'harga_total', 'keterangan_tambahan', 'kontak_penerima', 'user', 'cabang'];
